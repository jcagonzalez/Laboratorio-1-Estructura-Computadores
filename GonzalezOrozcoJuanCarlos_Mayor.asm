...
# Este programa pide al usuario entre 3 y 5 números y encuentra el número mayor

    .data
prompt:     .asciiz "Ingrese el número: " # Se piden los números al usuario
result:     .asciiz "El número mayor es: " # Se genera el resultado de la operación

    .text
    .globl main
main:
    li $t0, 3               # Contador de números ingresados (mínimo 3)
    li $t1, 0               # Número mayor inicial
...
loop:
    ...
    # Aquí se compara el número ingresado con el número mayor
    ble $t2, $t1, skip      
    move $t1, $t2           # Se actualiza el número mayor
...
# Aquí se imprime el resultado
    ...
    li $v0, 1
    move $a0, $t1           # Aquí se muestra el número mayor
    syscall
